...
(
    CustomerSK           int           IDENTITY(1001,1),  -- PK
...
(
    ...
    FullDateTimeAK     datetime     NULL,  -- AK
...
(
    SCD_ProductCostSK   int           Identity,  -- PK
...
(
    SCD_ProductPriceSK  int           Identity,  -- PK
...
(
    SalesTerritorySK      int           Identity,  -- PK
...
(
    ...
    PRIMARY KEY CLUSTERED (AccountSK)
)
;
...
(
    ...
    PRIMARY KEY CLUSTERED (EntitySK)
)
;
...
(
    ...
    PRIMARY KEY CLUSTERED (ScenarioSK)
)
go
...
(
    ExchangeRateSK     int           Identity,  -- PK
...
(
    StrategyPlanSK      int      Identity,  -- PK
    ...
    PRIMARY KEY CLUSTERED (StrategyPlanSK)
